...
using NCMDotNetCore.PizzaApi.Db;
using NCMDotNetCore.PizzaApi.Queries;
using NCMDotNetCore.Shared;

namespace NCMDotNetCore.PizzaApi.Features.Pizza
{
    ...
    public class PizzaController : ControllerBase
    {
        ...
        [HttpGet("Order/{invoiceNo}")]
            ...
            var lst = _dapperService.QueryFirstOrDefault<PizzaOrderInvoiceDetailModel>
                 (
